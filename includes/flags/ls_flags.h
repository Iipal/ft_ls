...
/*   Updated: 2019/11/28 14:18:26 by tmaluh           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FLAGS_USAGE "usage: ft_ls [-RafglrTtu1] [file ...]"
...
# define BIT_T_FULL_TIME  (1 << 7)
# define BIT_T_TIME       (1 << 8)
# define BIT_U_ACCESS     (1 << 9)
